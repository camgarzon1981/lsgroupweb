...
<br>
		...
		<tr><td valign="top" width="50%">	<table border="1" width="100%">
				...
				<?php foreach($usuariosls as $usuario){?>
					<tr><td><?php echo $usuario->name;?></td><td><?php echo $usuario->email;?></td><td align="center"><input type="checkbox" id="email[]" name="email[]" value="<?php echo $usuario->email;?>" /></td></tr>
				<?php }?>
			</table>
				...
				<tr><th>Nombre</th><th>Mail</th><th></th></tr>
				<?php foreach($usuariosaduanera as $usuario){?>
					<tr><td><?php echo $usuario->name;?></td><td><?php echo $usuario->email;?></td><td align="center"><input type="checkbox" id="email[]" name="email[]" value="<?php echo $usuario->email;?>" /></td></tr>
				<?php }?>
			</table>
			</td></tr>
